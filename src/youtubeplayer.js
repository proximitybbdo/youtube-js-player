...
YouTubePlayer = (function() {
  ...
  YouTubePlayer.prototype.add_player = function() {
    swfobject.embedSWF(   "http://www.youtube.com/v/" + this.video_id + "?enablejsapi=1&playerapiid=" + this.player_id + "&version=3", 
                          this.div_id, this.video_width, this.video_height, "8", null, null, 
                          { allowScriptAccess: "always", allowFullScreen: 'true' }, { id: this.embed_id, name: this.embed_id });
  }
